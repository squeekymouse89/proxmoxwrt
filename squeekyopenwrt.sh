...
wget $url -O /tmp/squeekysopenwrtrootfs.tar.xz
pct create $number /tmp/squeekysopenwrtrootfs.tar.xz --ostype unmanaged --hostname $name -net0 name=eth0 -net1 name=eth1
